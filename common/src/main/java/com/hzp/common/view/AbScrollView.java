...
/**
 * @author HZP
 * @version created at 2017/3/22 21:25
 * 具有反弹效果的ScrollView，能够兼容横向的滑动
 */
public class AbScrollView extends ScrollView {

    private static final int DIRECTION_TOP = 0x01;
    private static final int DIRECTION_BOTTOM = 0x10;
    private static final int DIRECTION_DEFAULT = 0x00;
    ...
    public AbScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AbScrollView, defStyleAttr, 0);
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int deltaY = Math.round((preY - nowY) * mFator);
                scrollBy(0, deltaY);
                y = nowY;
                ...
                if (isNeedMove()) {
                    ...
                    if (inner.getTop() > 0 && (mTargetDirection & DIRECTION_TOP) == DIRECTION_TOP)
                        deltaY = 0;

                    if (inner.getTop() < 0 && (mTargetDirection & DIRECTION_BOTTOM) == DIRECTION_BOTTOM)
                        deltaY = 0;
