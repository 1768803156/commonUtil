...
/**
 * @author HZP
 * @version created at 2017/3/25 22:56
 */
public class CustomTextView extends RelativeLayout {
    ...
    private OnItemClickListener OnTextViewClickListener;

    public CustomTextView setOnItemClickListener(OnItemClickListener listener) {
        ...
        /*this.setOnClickListener(new OnClickListener() {
            @Override public void onClick(View v) {
                if (OnTextViewClickListener != null) {
                    OnTextViewClickListener.OnItemClick();
                }
            }
        });*/
    }
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        bottomLineMarginLeft = typedArray.getDimensionPixelOffset(R.styleable.CustomTextView_bottomLineMarginLeft, 0);
        bottomLineMarginRight = typedArray.getDimensionPixelOffset(R.styleable.CustomTextView_bottomLineMarginRight, 0);
    ...
    private void initCenterTv() {
        ...
        centerTvParams.addRule(centerTVMarginleft != 0 && !TextUtils.isEmpty(leftTvString) ? RelativeLayout.RIGHT_OF :
                RelativeLayout.CENTER_IN_PARENT, centerTVMarginleft != 0
                && !TextUtils
                .isEmpty(leftTvString) ? R.id.leftTv : TRUE);
    ...
    private void initBottomLine() {
        ...
        if (bottomLineMargin == 0) bottomParams.setMargins(bottomLineMarginLeft, 0, bottomLineMarginRight, 0);
        else {
